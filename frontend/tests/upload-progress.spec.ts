...
test('live status advances processing steps and closes transcription progress', async ({
  page,
}) => {
  ...
  await expect(page.locator('section[aria-label="Processing status"] > div > span')).toHaveText(
    'Step 3 of 4'
  );
