...
export default function Toast({ message, duration = 3500, onClose, placementClassName = 'right-4 top-12' }: ToastProps) {
  ...
  return (
    <div className={wrapperClass}>
      <div role="status" aria-live="polite" aria-atomic="true" className={`pointer-events-auto rounded bg-black/85 text-white px-3 py-2 text-sm shadow-lg flex items-center gap-3 transform transition-all duration-200 ease-out ${visible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-2'}`}>
