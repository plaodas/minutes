    ...
    <div>
      <div className="mb-4">
        ...
        <p className="text-sm text-[var(--muted)]">
          Create and revoke service tokens for programmatic access.
        </p>
      </div>
      ...
      <form onSubmit={handleCreate} className="mb-4 flex flex-col sm:flex-row gap-2">
        ...
        <input
          ...
          placeholder="associate user id (optional)"
          className="rounded border px-2 py-1"
        />
        <button className="rounded bg-[var(--accent)] px-3 py-1 text-white" type="submit">
          Create token
        </button>
      </form>
